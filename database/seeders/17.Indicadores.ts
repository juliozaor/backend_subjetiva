    ...
    await TblIndicadores.createMany([
      {
        ...
        id: 4,
        nombre: 'Cumplimiento de metas del MESS - Modelos de Negocios Especiales',
        ...
        id: 11,
        nombre: 'Cumplimiento plan de formación en seguridad vial CPF MESS - Modelos de Negocios Especiales',
        descripcion:'Registro de avance trimestral del plan de formación en seguridad vial CPF MESS - Modelos de Negocios Especiales, respecto a la programación de las capacitaciones reportado en la plataforma y el porcentaje de ejecución de estas, medido en forma acumulativa',
        codigo: '11'
      },{
        id: 12,
        nombre: 'Cobertura plan de formación en seguridad vial CPF MESS - Modelos de Negocios Especiales',
